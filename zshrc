...
plugins=(git osx svn rvm ruby rails brew bundler gem rake heroku java maven mvn gradle ant adb pip python zeus npm cap guardi go golang ant gpg virtualenvi docker nvm npm bower)
